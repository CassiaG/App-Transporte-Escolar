...
public class Enderecos4 extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.enderecos4);
		selecionarDados2();
...
Button volt = (Button) findViewById (R.id.button2);
		...
		volt.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				startActivity(new Intent (Enderecos4.this, MainActivity.class));
		...
		endereco.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				startActivity(new Intent (Enderecos4.this, Enderecos3.class));
