...
public class chamadaContatocel extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.chamadacontatotel);
		selecionarDadosCel();
		...
		menu.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				startActivity(new Intent (chamadaContatocel.this, MainActivity.class));
		...
		telefone.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				startActivity(new Intent (chamadaContatocel.this, chamadaContato.class));
	...
	@Override
	public void onClick(View arg0) {
		startActivity(new Intent (chamadaContatocel.this, chamadaContatocont.class));
 ...
 //Activity, isso tambem é possivel
	...
	*/
	...
	public ArrayList<String> selecionarDadosCel(){
		cursor = null;
		...
		try {
			...
			while (cursor.moveToNext()){
				...
				String ID = cursor.getString(cursor.getColumnIndex("celular"));
 ...
 //pega a posição da pessoa
            	...
            	Intent chama = new Intent(Intent.ACTION_DIAL);
                  
                  chama.setData(Uri.parse("tel:" + selecionarDadosCel().get(_cao)));
