...
public class Contatocel extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.contatotel);
		selecionarDadosCel();
		...
		menu.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				startActivity(new Intent (Contatocel.this, Cmeni.class));
		...
		telefone.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				startActivity(new Intent (Contatocel.this, Contato.class));
	...
	@Override
	public void onClick(View arg0) {
		startActivity(new Intent (Contatocel.this, Contatocont.class));
