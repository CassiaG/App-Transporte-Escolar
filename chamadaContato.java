...
public class chamadaContato extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.chamadacontato);
		selecionarDadosTel();
		...
		menu.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				startActivity(new Intent (chamadaContato.this, MainActivity.class));
		...
		celular.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				startActivity(new Intent (chamadaContato.this, chamadaContatocel.class));
	...
	@Override
	public void onClick(View arg0) {
		startActivity(new Intent (chamadaContato.this, chamadaContatocont.class));
