...
public class Enderecos extends Activity{
	...
	Button volt = (Button) findViewById (R.id.button2);
		...
		volt.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				startActivity(new Intent (Enderecos.this, Cmeni.class));
		...
		endereco2.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				startActivity(new Intent (Enderecos.this, Enderecos2.class));
	...
	public ArrayList<String> selecionarDados(){
		...
		try {
			...
			while (cursor.moveToNext()){
				...
				String ID = cursor.getString(cursor.getColumnIndex("rua"));
				String v = cursor.getString(cursor.getColumnIndex("cidade"));
			...
			/*	hashMapLocation = new HashMap<String, Store>();
				for (Store s : stores.getList()) {
				   if (s.getLatitude() != null && s.getLongitude() != null) {
				       Log.i(TAG, "Adding Store Marker: " + s.getIdServer() + " : " + s.getLatitude() + ", " + s.getLongitude());
				       LatLng point = new LatLng(Double.valueOf(s.getLatitude()), Double.valueOf(s.getLongitude()));
				       Marker marker = googleMap.addMarker(new MarkerOptions().position(point).title(s.getIdServer() + " - " + s.getName()).icon(BitmapDescriptorFactory.defaultMarker()).snippet("Clique para selecionar loja"));
				       hashMapLocation.put(marker.getId(), s);
				    }*/
			//	}
...
//pega a posição da pessoa
           ...
           Uri urimaps = Uri.parse("https://www.google.com.br/maps/preview#!data=!1m4!1m3!1d2982299!2d-48.6355141!3d-22.5460521/‎‎"+ selecionarDados().get(_posicao));
