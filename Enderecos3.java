...
public class Enderecos3 extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.enderecos3);
		selecionarDados();
	...
	Button volt = (Button) findViewById (R.id.button2);
		...
		volt.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				startActivity(new Intent (Enderecos3.this, MainActivity.class));
		...
		endereco2.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				startActivity(new Intent (Enderecos3.this, Enderecos4.class));
